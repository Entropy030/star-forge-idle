...
export const i18n = {
  en: {
    ...
    milestone_tooltip: "Next Milestone (Lvl {lvl}): +5% Hydrogen Yield",
...
export const COSMIC_REGISTRY = {
  ...
  resources: {
    ...
    hydrogen: { id: "hydrogen", name: "Hydrogen", baseGen: 10 },
  ...
  constants: {
    ...
    recombinationProtonThreshold: 25000,
    supernovaTempThreshold: 100000000,
    supernovaIronThreshold: 100,
    galacticIgnitionIronThreshold: 1000,
