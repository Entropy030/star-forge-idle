...
18. **P5 Future Roadmap:** P5.2 (Progression & Mechanic Introduction / Prestige Onboarding), P5.3 (Incremental Economy & Agency / Stock → Flow → Conversion → Policy), and P5.4 (Coarse Balance & Full Run Validation). Next activity: external/reference incremental benchmark research.
